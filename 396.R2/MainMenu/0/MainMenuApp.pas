...
type
  TMainApp = class(TForm)
    ...
    procedure scListMenuItemClick(Sender: TObject);
...
begin
  ...
  //CodeSite.Send('c3-ido:'+ ICSSession.Office_id );
...
begin
    ...
    begin
      ...
      FotoFile :=
        ...
        DM.FDT_ConfigApp.FieldByName('confvalue').AsString );
...
procedure TMainApp.scListMenuItemClick(Sender: TObject);
var sit : string;
  i:integer;
