...
//  frxDesgn, frxClass, frxDBSet,frxBarcode,frxPrinter,
  ...
  ,scGPImages, Vcl.ExtDlgs,
   ...
   Vcl.StdActns, hyiedefs, hyieutils, iexBitmaps, iesettings,
   iexUserInteractions, imageenio,
  imageenproc, ieview, imageenview
  ,ImagMainFrm
//  ,iexActions ,iexRulers, iexToolbars,iexLayers,

  ,CodeSiteLogging,CodeSiteJsonLogging

  ,uRestVCL, frxClass, frxDBSet, WPCTRRich, WPTbar, WPRTEDefs, WPCTRMemo,
  WPRuler, Wpdbrich, iexLayers, iexRulers, iexToolbars
...
type
  ...
  TFCustRegister = class(TForm)
    ...
    btRigester: TscGPCharGlyphButton;
    ...
    scPageCetakMtList: TscPageViewerPage;
    scPanelmain: TscPanel;
    ...
    mtList: TFDMemTable;
    gxReportNAMA_IDLEGAL: TcxGridDBBandedColumn;
    gxReportUMUR: TcxGridDBBandedColumn;
    gxReportGENDER: TcxGridDBBandedColumn;
...
//const
  ...
  scPageCentral.PageIndex  := scPageRegister.Tag;
  ...
  //load template form pemohonan
  loadFrPermohonan;

  DecodeDate(Now(),yy,mm,dd);
  dd := DaysInMonth( Now() );
  eDate2.EditValue := EncodeDateTime( yy,mm,dd, 23, 59, 00, 00 );
end;
...
procedure TFCustRegister.loadFrPermohonan;
begin
      ...
      begin
        ...
        try
          ...
          ICSMVCAppRequest( MainApp.ICSSession ,
            'GET',
            '/ics/TFR/rtf/fAppAnggota'  //endpoint request
           );
          Codesite.send('1- cek WRP' +Response.content);

          if Response.StatusCode = 200 then begin

            Codesite.send('2- cek WRP ada data');

            TThread.Synchronize(nil,procedure begin

              Codesite.send('3- cek WRP data masuk');

              WPRichText1.RTFText.AsString :=  Response.content;
...
begin
      ...
      //try
          ...
          if err = 0 then begin
              ...
              body.S['go_date']      := DateToISO8601(Now()); //eTglPermohonan.DateTime LAST:20230408

              CodeSite.send('1/5/TEST/'+ DateToISO8601(Now()) );
              ...
              CodeSite.send('2/2');
              CodeSite.send('2/3/'+OBJson.toString);
    ...
    //                2: diluar zinasi = "anggota luar biasa"
              ...
              TTask.Run(procedure
                  ...
                  begin
                    ...
                    CodeSite.Send('CIF/2/2/'+asgProfile.Cells[1, FCustomer_CIF]);
                    curlImg := '/ics/ATIMAGE/A2/'+asgProfile.Cells[1, FCustomer_CIF];
                    ...
                    CodeSite.Send('Response/2/2/'+Response.Content);
                    ...
                    if Response.StatusCode = 200 then begin
                        ...
                        m.Position:= 0;
                        ImageEnView1.IO.LoadFromStream(m,ioUnknown);
...
procedure TFCustRegister.ShowFieldsClick(Sender: TObject);
begin
if ShowFields.Checked then
  ...
  dpMtList.ShowFieldNames :=  ShowFields.Checked;
end;
